...
Your documentation should serve two audiences: human developers who need to understand and use the code, and AI agents who need context to work effectively. Strike a balance between comprehensiveness and conciseness - every sentence should add value.
